...
Measured 2026-09-26T10:01:41+00:00 from the live published indexes;
...
> **⚠ the previous measurement is 21 days old.** The refresh PR is not merging; every delta
> below spans that whole window, and nothing in between
> was recorded.

| target/arch | built Δ | needed Δ | no movement for | newly built |
|---|---|---|---|---|
| debian/amd64 | +0 | +0 | 32 days | — |
| debian/arm64 | +0 | +0 | 32 days | — |
| el10/aarch64 | +0 | +0 | 32 days | — |
| el10/x86_64 | +0 | +0 | 24 days | — |
| fedora/x86_64 | +0 | +0 | ≥ 36 days | — |
| hummingbird/aarch64 | +1 | -1 | — | libosinfo |
| hummingbird/x86_64 | +1 | -1 | — | libosinfo |
| opensuse-tumbleweed/aarch64 | +0 | +0 | 24 days | — |
| opensuse-tumbleweed/x86_64 | +0 | +0 | 24 days | — |
| ubuntu/amd64 | +0 | +0 | 32 days | — |
| ubuntu/arm64 | +0 | +0 | 32 days | — |
...
| arch | catalog entries | built | needed | index packages |
|---|---|---|---|---|
| aarch64 | 665 | 625 | 40 | 3913 |
| x86_64 | 665 | 644 | 21 | 8819 |

Needed on aarch64 (40):
