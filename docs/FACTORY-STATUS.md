...
Measured 2026-09-19T09:38:54+00:00 from the live published indexes;
...
> **⚠ the previous measurement is 14 days old.** The refresh PR is not merging; every delta
> below spans that whole window, and nothing in between
> was recorded.

| target/arch | built Δ | needed Δ | no movement for | newly built |
|---|---|---|---|---|
| debian/amd64 | +0 | +0 | 25 days | — |
| debian/arm64 | +0 | +0 | 25 days | — |
| el10/aarch64 | +0 | +0 | 25 days | — |
| el10/x86_64 | +0 | +0 | 16 days | — |
| fedora/x86_64 | +0 | +0 | ≥ 29 days | — |
| hummingbird/aarch64 | +1 | -1 | — | libosinfo |
| hummingbird/x86_64 | +1 | -1 | — | libosinfo |
| opensuse-tumbleweed/aarch64 | +0 | +0 | 16 days | — |
| opensuse-tumbleweed/x86_64 | +0 | +0 | 16 days | — |
| ubuntu/amd64 | +0 | +0 | 25 days | — |
| ubuntu/arm64 | +0 | +0 | 25 days | — |
